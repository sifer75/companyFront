...
import { login } from "../../lib/company.request";
    ...
    <div className="w-screen h-screen bg-fontPage py-20 px-44">
      <div className="flex w-full h-full rounded-lg">
        ...
        <div className="flex flex-col bg-white h-full w-1/2 gap-8 px-16 py-20 justify-center">
          <h1 className="text-buttonPurple font-bold text-2xl">Login</h1>
          ...
          <div className="flex justify-between">
            <Link to={"/createaccount"}>
              <button
                className={`flex py-1 px-2 justify-center items-center flex-shrink-0 rounded-md shadow-md border-2 border-buttonPurple h-full`}
              >
